...
<!-- output:the_nul_byte_kata_py -->
*Verified output of [`the_nul_byte_kata_py.py`](examples/the_nul_byte_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
