...
- [UTF-16 and surrogates](../../03_Encodings/utf16_and_surrogates/README.md) — the per-character loop one level further down, where a `char` is half a letter
