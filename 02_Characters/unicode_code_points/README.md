...
<!-- output:unicode_code_points_kata_py -->
*Verified output of [`unicode_code_points_kata_py.py`](examples/unicode_code_points_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
...
- [The table has a version](../the_table_has_a_version/README.md) — whose copy of the table answered the questions above, and why the whitespace scan has so far been safe when a count would not be
