...
<!-- output:confusables_and_scripts_kata_py -->
*Verified output of [`confusables_and_scripts_kata_py.py`](examples/confusables_and_scripts_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
