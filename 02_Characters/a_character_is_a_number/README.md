...
Then the edge. Try the same two tricks on `'７'` (full-width), `'٧'` (Arabic-Indic), `'é'` and `'ß'`, and say which of the four breaks each trick and how. One of them makes a string longer.

<details markdown="1">
<summary><strong>Answers</strong></summary>

<!-- output:a_character_is_a_number_kata_py -->
*Verified output of [`a_character_is_a_number_kata_py.py`](examples/a_character_is_a_number_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
...
3. WHERE EACH ONE STOPS
   ...
   full-width '７'         ord-0x30 gives 65255  int() gives 7
