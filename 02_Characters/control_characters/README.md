...
<!-- output:control_characters_kata_py -->
*Verified output of [`control_characters_kata_py.py`](examples/control_characters_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
