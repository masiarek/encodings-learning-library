...
<!-- output:utf16_and_surrogates_kata_py -->
*Verified output of [`utf16_and_surrogates_kata_py.py`](examples/utf16_and_surrogates_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
...
- [Bytes that are not text](../../04_Python/surrogateescape/README.md) — the other reason a `str` holds a lone surrogate, and the handler that puts the byte back
