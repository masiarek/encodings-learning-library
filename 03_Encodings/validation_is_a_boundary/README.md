...
<!-- output:validation_is_a_boundary_kata_py -->
*Verified output of [`validation_is_a_boundary_kata_py.py`](examples/validation_is_a_boundary_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
