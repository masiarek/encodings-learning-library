...
<!-- output:encode_and_decode_are_verbs_kata_py -->
*Verified output of [`encode_and_decode_are_verbs_kata_py.py`](examples/encode_and_decode_are_verbs_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*

```text
start with   'café'   ->  utf-8 bytes 63 61 66 c3 a9

   B.decode('utf-8')            round trip      str  'café'
   B.decode('latin-1')          wrong table     str  'cafÃ©'
