...
- [A length you did not check ↗](https://masiarek.github.io/c-learning-library/05_Bytes_on_the_Wire/a_length_you_did_not_check/index.html) — the length field's other half in C: a length off the wire is a claim, not a fact, and trusting it is the classic overflow
