...
| **ABAP** | the `TYPE` of the field, which fixes the width | not applicable; the conversion is at the file boundary | at `TRANSFER` / `MOVE`, by truncation |
