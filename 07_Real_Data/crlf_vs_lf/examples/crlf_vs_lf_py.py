...
print("   module asks for, and bytes are what you get from a socket, a zipfile,")
print("   a subprocess with text=False, and a database column. The protection")
print("   covers one path, and the CR is waiting on all the others.")
