...
- **A C track.** Not a fourth language; a short *The C view* aside where it sharpens the point, compiled and checked like the others. The runner takes `examples/*.c` since 2026-09-05 and [Control characters](02_Characters/control_characters/README.md) has the first one (NUL and `strlen`); UTF-8 by hand gets the second.
