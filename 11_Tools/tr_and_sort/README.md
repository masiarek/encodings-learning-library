...
<!-- output:tr_and_sort_kata_sh -->
*Verified output of [`tr_and_sort_kata_sh.sh`](examples/tr_and_sort_kata_sh.sh) — regenerated by `tools/run_examples.py`, never hand-typed.*
