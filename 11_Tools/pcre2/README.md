...
<!-- output:pcre2_kata_py -->
*Verified output of [`pcre2_kata_py.py`](examples/pcre2_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*

```text
the string   'é'   draws as é
