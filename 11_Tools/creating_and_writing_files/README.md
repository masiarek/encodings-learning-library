...
<!-- output:creating_and_writing_files_kata_sh -->
*Verified output of [`creating_and_writing_files_kata_sh.sh`](examples/creating_and_writing_files_kata_sh.sh) — regenerated by `tools/run_examples.py`, never hand-typed.*
