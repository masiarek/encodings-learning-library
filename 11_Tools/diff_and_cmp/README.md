...
<!-- output:diff_and_cmp_kata_sh -->
*Verified output of [`diff_and_cmp_kata_sh.sh`](examples/diff_and_cmp_kata_sh.sh) — regenerated by `tools/run_examples.py`, never hand-typed.*

```text
TWO FILES THAT DRAW IDENTICALLY
   nfc.txt  636166c3a90a     café
   nfd.txt  63616665cc810a   café
