...
<!-- output:hex_is_a_shorthand_kata_py -->
*Verified output of [`hex_is_a_shorthand_kata_py.py`](examples/hex_is_a_shorthand_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
