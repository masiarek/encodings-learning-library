...
<!-- output:reading_a_hex_dump_kata_sh -->
*Verified output of [`reading_a_hex_dump_kata_sh.sh`](examples/reading_a_hex_dump_kata_sh.sh) — regenerated by `tools/run_examples.py`, never hand-typed.*
...
- [`xxd` is the dump you can put back](../../11_Tools/xxd/README.md) — the same three columns, and which of them survives a round trip
