...
<!-- output:rust_strings_in_practice_kata_rs -->
*Verified output of [`rust_strings_in_practice_kata_rs.rs`](examples/rust_strings_in_practice_kata_rs.rs) — regenerated by `tools/run_examples.py`, never hand-typed.*
