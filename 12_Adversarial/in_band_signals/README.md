...
<!-- output:in_band_signals_kata_py -->
*Verified output of [`in_band_signals_kata_py.py`](examples/in_band_signals_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
