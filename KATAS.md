...
| K19 | [Nine ways out of one string, and the two bytes it will not carry](04_Python/surrogateescape/README.md#practice) | [Bytes that are not text](04_Python/surrogateescape/README.md) | 201 → 301 |
| K20 | [Six round trips, and the three that come back unchanged](10_Best_Practices/what_your_language_gives_you/README.md#practice) | ["Handles Unicode" is four questions](10_Best_Practices/what_your_language_gives_you/README.md) | 301 |
| K21 | [Seven ways to blank a file, and the one that leaves the old bytes behind](11_Tools/creating_and_writing_files/README.md#practice) | [`touch`, `: >` and `install`](11_Tools/creating_and_writing_files/README.md) | 201 |
