...
| [Unicode Character Encoding Stability Policies ↗](https://www.unicode.org/policies/stability_policy.html) | The short list of things Unicode promises never to change — a character's name, its code point, and the set of noncharacters. The rule that decides which numbers may go in an answer key, on [The table has a version](02_Characters/the_table_has_a_version/README.md) and [Noncharacters and the private use areas](02_Characters/noncharacters_and_private_use/README.md). |
