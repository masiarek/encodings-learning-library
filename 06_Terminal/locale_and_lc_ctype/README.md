...
<!-- output:locale_and_lc_ctype_kata_py -->
*Verified output of [`locale_and_lc_ctype_kata_py.py`](examples/locale_and_lc_ctype_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
