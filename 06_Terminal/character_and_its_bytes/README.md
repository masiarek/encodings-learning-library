...
<!-- output:character_and_its_bytes_kata_sh -->
*Verified output of [`character_and_its_bytes_kata_sh.sh`](examples/character_and_its_bytes_kata_sh.sh) — regenerated by `tools/run_examples.py`, never hand-typed.*
