...
<!-- output:trailing_newline_kata_sh -->
*Verified output of [`trailing_newline_kata_sh.sh`](examples/trailing_newline_kata_sh.sh) — regenerated by `tools/run_examples.py`, never hand-typed.*
