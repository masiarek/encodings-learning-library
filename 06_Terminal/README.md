...
|---|---|---|---|
| 1 | [`printf` writes bytes](printf_writes_bytes/README.md) | How do I put exactly the bytes I mean in front of `xxd`? | written |
...
| 5 | [`iconv`](iconv/README.md) | How do I re-encode a file, and what does its refusal mean? | written |
