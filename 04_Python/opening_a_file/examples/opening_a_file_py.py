...
print("   program. That is what a container, a cron job and a systemd unit")
print("   look like unless somebody set a variable.")
print()
...
print()
print("   The print() column is the same bet made on the way OUT, and it is")
print("   why a script that prints an e-acute happily in your terminal dies")
print("   under cron: cron does not set your locale. Nothing about the")
print("   program changed -- only who started it.")
print()
