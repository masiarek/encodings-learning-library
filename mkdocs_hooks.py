...
NAV_ORDER: dict[str, list[str]] = {
    ...
    # The annotated man pages, by subject: the encodings, then the C API that
    # decodes them, the locale that names them, the converters, and the tools.
    "13_Documentation/manual_pages": [
        "README.md",
        "utf8.md",
        "cjk_encodings.md",
        "charsets.md",
    ...
    # The import dialog's own order: the twenty-four loaders as Ghidra lists
    # them, alphabetically by display name, with the two "Input Format"s last.
    "16_Formats": [
        "README.md",
        "android_apk",
        "coff",
