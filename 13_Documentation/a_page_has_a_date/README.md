...
<!-- output:a_page_has_a_date_kata_py -->
*Verified output of [`a_page_has_a_date_kata_py.py`](examples/a_page_has_a_date_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
