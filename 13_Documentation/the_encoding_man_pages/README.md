...
<!-- output:the_encoding_man_pages_kata_py -->
*Verified output of [`the_encoding_man_pages_kata_py.py`](examples/the_encoding_man_pages_kata_py.py) — regenerated by `tools/run_examples.py`, never hand-typed.*
