...
That third shape is the argument in miniature: **the numbers in a generated block are evidence and the prose beside them is assertion, and they sit inside the same fence looking identical.** All four had been read many times. When a claim in a print statement is doing teaching work, measure it, and if the measurement is platform- or version-dependent put it in a dated fence on the page rather than in the key.
