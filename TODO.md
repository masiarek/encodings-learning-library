...
| 11 | ~~[Fixed-width byte fields](07_Real_Data/fixed_width_byte_fields/README.md)~~ | 07 | **Written 2026-09-07.** The hook held and the number underneath it is the lesson: **9 of the 26 possible widths split this one value and 17 do not**, so whether `encode()[:n]` is a bug is a property of the data, not the code |
