...
| # | Page | Lands in | The hook to verify |
|---|---|---|---|
| 23 | Bytes that are not text — `surrogateescape` | 04 | [PEP 383 ↗](https://peps.python.org/pep-0383/) round-trips an undecodable filename *through* a `str`. The mechanism behind `os.fsdecode`, and the honest answer to "but the filename isn't UTF-8" |
